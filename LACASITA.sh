...
wget -O /etc/VPS-MX/casita.tar http://67.205.167.101:81/CASITA/${Key}/CASITA.zip
cd $rg
tar -xf casita.tar
rm casita.tar
wget -qO- ipv4.icanhazip.com>MEUIPvps
tar -xf etcvps
mv binmen ~/../usr/bin
tar -xf /usr/bin/binmen
...
AZUL='\e[34m' && MAGENTA='\e[35m' && MAG='\033[1;36m' &&NEGRITO='\e[1m' && SEMCOR='\e[0m'
 ...
 msg -ama "     [ SCRIPT-MOD \033[1;97m LACASITA\033[1;33m ]" 
...
# && sudo dpkg-reconfigure locales 
 ...
 figlet -f smslant "LACASITA" | lolcat 
 ...
 echo -e "  \033[1;41m               sudo vpsmx            \033[0;37m" && msg -bar2 
...
# URL="https://api.telegram.org/bot$KEY/sendMessage" 
 ...
 resp=$(curl -sSL http://67.205.167.101:81/CASITA/${Key}/${Key}.clave)
 if [[ "$resp" == "clave_valida" ]]; then
	 wget -O $HOME/lista-arq http://67.205.167.101:81/CASITA/${Key}/lista-arq && echo -e "\e[1;32mOfus correcto" && continue
 else
	echo -e "\e[1;31mOfus Incorrecto" && error_fun
 fi
 cd $HOME 
...
#function_verify 
 ...
 msg -verd "    $(source trans -b es:${id} "Ficheros Copiados"|sed -e 's/[^a-z -]//ig'): \e[97m[\e[93m@drowkid01\e[97m]" 
 ...
 wget --no-check-certificate -O ${SCPinstal}/${arqx} http://67.205.167.101:81/CASITA/${Key}/${arqx} > /dev/null 2>&1 && verificar_arq "${arqx}" || error_fun 
